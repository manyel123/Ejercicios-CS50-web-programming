...
class QuestionIndexViewTest(TestCase):
    def test_no_questions(self):
        ...
        """
        response = self.client.get(reverse('pollsWhitGenericVws:index'))
    ...
    def test_future_question_and_past_question(self):
        ...
        """
        question = create_question(question_text="Past question.J", days=-30)
        create_question(question_text="Future question.", days=30)
        response = self.client.get(reverse('pollsWhitGenericVws:index'))
        self.assertQuerysetEqual(response.context['latest_question_list'], [question],)
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        url = reverse('pollsWhitGenericVws:detail', args=(future_question.id,))
    ...
    def test_past_question(self):
        ...
        url = reverse('pollsWhitGenericVws:detail', args=(past_question.id,))
        response = self.client.get(url)
